...
ActiveRecord::Schema.define(version: 20151025064517) do
  ...
  add_index "attachments", ["stub_id"], name: "index_attachments_on_stub_id"
  ...
  add_index "comments", ["stub_id"], name: "index_comments_on_stub_id"
